<!-- Modal -->
<div class="modal fade" id="actualizar-cliente-modal" tabindex="-1" aria-labelledby="actualizar-cliente-modal"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h1 class="modal-title fs-5 w-100" id="exampleModalLabel">Actualizar Cliente</h1>
            </div>
                ...
                <div class="col-12 grid-margin">
                        ...
                        <form class="forms-sample form-cliente" id="formulario">
                            ...
                            <div class="form-group formulario__grupo formulario__grupo-correcto" id="grupo__id">
                                <label for="id_cliente" class="formulario__label">ID del Cliente</label>
                                <div class="formulario__grupo-input input-group">
                                    ...
                                    <input disabled type="text" class="col-sm-3 form-control formulario__grupo-input" id="id_cliente" name="id">
                                </div>
                            </div>
