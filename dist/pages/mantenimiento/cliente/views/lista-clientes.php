...
<body id="my-scrollbar">
                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item">Mantenimientos</div>
                            <div class="breadcrumb-item">Lista de Clientes</div>
                        </div>
                    </div>

                    <div class="section-body">
                        <h2 class="section-title">Lista de Clientes</h2>
                        <p class="section-lead">Lista de clientes registrados.</p>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-form">
                                                <div class="input-group">
                                                    <input type="search" class="form-control" placeholder="Buscar cliente" id="search">
    ...
    <!-- Funcionalidades web -->
    <script type="module" src="../controllers/ListaClientes.js"></script>
    <!-- Underscore -->
