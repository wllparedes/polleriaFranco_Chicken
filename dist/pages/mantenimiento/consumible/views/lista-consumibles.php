...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Tabla: Consumibles</h1>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="#">Inicio</a></div>
                            <div class="breadcrumb-item">Mantenimiento</div>
                            <div class="breadcrumb-item">Lista de Consumibles</div>
                        </div>
                    </div>

                    <div class="section-body">
                        <h2 class="section-title">Lista de Consumibles</h2>
                        <p class="section-lead">Lista de Consumibles registrados.</p>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Tabla Consumibles:</h4>
                                        <div class="card-header-form">
                                            <form>
                                                <div class="input-group">
                                                    <input type="search" class="form-control"
                                                        placeholder="Buscar consumible" id="search">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            ...
                                            <table id="tabla" class="table table-hover">
                                                ...
                                                <tbody id="consumibles-result">
                                                <tbody>
                                                    <!-- Busqueda de consumibles -->
                                                </tbody>
                                                </tbody>
    ...
    <!-- Funcionalidades web -->
    <script type="module" src="../controllers/ListaConsumibles.js"></script>
    <!-- Underscore -->
    ...
    <!-- Modal Actualziar consumible -->
    <?php include("actualizar-consumible.php") ?>
