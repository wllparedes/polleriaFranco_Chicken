...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        ...
                        <p class="section-lead">Lista de proveedores registrados.</p>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-form">
                                                <div class="input-group">
                                                    <input type="search" class="form-control" placeholder="Buscar proveedor" id="search">
    ...
    <!-- Funcionalidades web -->
    <script type="module" src="../controllers/ListaProveedores.js"></script>
    <!-- Underscore -->
    <script src="../../../../assets/js/underscore-min.js"></script>
    <!-- Modal Actualziar Cliente -->
    <?php include("actualizar-proveedor.php") ?>
    <!-- Phone PE -->
