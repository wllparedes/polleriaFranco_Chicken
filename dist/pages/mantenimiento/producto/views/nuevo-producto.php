...
<body>
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            ...
            <p class="section-lead">Rellene la información requerida para poder crear un nuevo producto.
            </p>
                  ...
                  <div class="card-body">
                    <form class="forms-sample form-producto" id="formulario">
                      ...
                      <div class="row">
                        ...
                        <!-- Grupo: Nombre -->
                        <div class="form-group col-md-6 formulario__grupo" id="grupo__producto">
                          <label for="producto" class="formulario__label">Nombre</label>
                          <div class="formulario__grupo-input input-group">
                            ...
                            <input type="text" class="form-control formulario__grupo-input" id="producto"
                              name="producto" placeholder="Arroz">
                            <span class="fas fa-exclamation-circle formulario__validacion-estado"></span>
                          </div>
                          <div class="formulario__input-error">
                            El nombre del producto debe ser de 4 a 35 dígitos y debe de
                            tener la porción.
                          </div>
                        </div>
                        ...
                        <div class="form-group col-md-6 formulario__grupo" id="grupo__descripcion">
                          ...
                          <div class="formulario__grupo-input input-group">
                            ...
                            <input maxlength="90" type="text" class="form-control formulario__grupo-input"
                              ...
                              placeholder="Arroz es un cereal la cual se combine con diferentes platillos...">
                            <span class="fas fa-exclamation-circle formulario__validacion-estado"></span>
                          </div>
                          <div class="formulario__input-error">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6 formulario__grupo" id="grupo__precio">
                          <label for="precio" class="formulario__label">Precio (por kg)</label>
                          <div class="formulario__grupo-input input-group">
                            <div class="input-group-prepend">
                              <div class="input-group-text">
  ...
  <script type="module" src="../controllers/NuevoProducto.js"></script>
