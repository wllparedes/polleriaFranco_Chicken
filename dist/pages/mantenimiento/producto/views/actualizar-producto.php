<!-- Modal -->
<div class="modal fade" id="actualizar-producto-modal" tabindex="-1" aria-labelledby="actualizar-producto-modal"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title fs-5 w-100" id="exampleModalLabel">Actualizar Producto</h1>
      </div>
      <div class="modal-body">
        ...
        <div class="col-12 grid-margin">
          <!-- <div class="card-body"> -->
          <!-- <p class="card-description"> Actualizar información del producto</p> -->
          <form class="forms-sample form-producto" id="formulario">

            <!-- Grupo: ID del consumible -->
            <div class="form-group formulario__grupo formulario__grupo-correcto" id="grupo__id">
              <label for="id_producto" class="formulario__label">ID del Producto</label>
              <div class="formulario__grupo-input input-group">
                ...
                <input disabled type="text" class="col-sm-3 form-control formulario__grupo-input" id="id_producto" name="id">
              </div>
            </div>

            <!-- Grupo: Nombre -->
            <div class="form-group formulario__grupo formulario__grupo-correcto" id="grupo__producto">
              <label for="n_producto" class="formulario__label">Nombre</label>
              <div class="formulario__grupo-input input-group">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                ...
                <input type="text" class="form-control formulario__grupo-input" id="n_producto" name="producto"
                  placeholder="Arroz">
                <span class="fas fa-check-circle formulario__validacion-estado"></span>
              </div>
              <div class="formulario__input-error">
                El nombre del producto debe ser de 4 a 35 dígitos y debe de tener la porción.
              </div>
            </div>
            ...
            <div class="form-group formulario__grupo formulario__grupo-correcto" id="grupo__descripcion">
              ...
              <div class="formulario__grupo-input input-group">
                ...
                <input maxlength="90" type="text" class="form-control formulario__grupo-input" id="n_descripcion"
                  name="descripcion" placeholder="Arroz es un cereal la cual se combine con diferentes platillos...">
                <span class="fas fa-check-circle formulario__validacion-estado"></span>
              </div>
              <div class="formulario__input-error">
