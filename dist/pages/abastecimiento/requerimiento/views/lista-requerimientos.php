...
<body id="my-scrollbar">
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Tabla: Requerimientos</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Inicio</a></div>
              <div class="breadcrumb-item">Abastecimiento</div>
              <div class="breadcrumb-item">Lista Requerimientos</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Lista de Requerimientos</h2>
            <p class="section-lead">Lista de Requerimientos registrados.</p>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Tabla Requerimientos:</h4>
                    <div class="card-header-form">
                      <div class="input-group">
                        <input type="search" class="form-control" placeholder="Buscar requerimiento" id="search">
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      ...
                      <table id="tabla" class="table table-hover">
                        ...
                        <tbody id="requerimientos-result">
                        <tbody>
  ...
  <!-- Funcionalidades web -->
  <script type="module" src="../controllers/ListaRequerimientos.js"></script>
  <!-- Underscore -->
