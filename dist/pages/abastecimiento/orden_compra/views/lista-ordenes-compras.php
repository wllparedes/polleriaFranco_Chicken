...
<body>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Tabla: Ordenes de Compras</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Inicio</a></div>
              <div class="breadcrumb-item">Abastecimiento</div>
              <div class="breadcrumb-item">Lista de Ordenes de compras</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Lista de Ordenes de compras</h2>
            <p class="section-lead">Lista de Ordenes de compras registrados.</p>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Tabla Ordenes de compras:</h4>
                    <div class="card-header-form">
                      <div class="input-group">
                        <input type="search" class="form-control" placeholder="Buscar ordenes" id="search">
  ...
  <!-- Funcionalidades web -->
  <script type="module" src="../controllers/ListaOrdenesCompras.js"></script>
  <!-- Underscore -->
