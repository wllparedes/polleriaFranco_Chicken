...
<body id="my-scrollbar">
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Formulario: Nuevo Comprobante</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Inicio</a></div>
              <div class="breadcrumb-item">Facturación</a></div>
              <div class="breadcrumb-item">Nuevo Comprobante</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Nuevo Comprobante</h2>
            <p class="section-lead">Rellene la información requerida para poder crear un nuevo comprobante.
            </p>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="forms-sample form-cliente" id="formulario">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6 formulario__grupo" id="grupo__metodo">
                          ...
                          <div class="formulario__grupo-input input-group">
                            ...
                            <!-- Seleccionar Mesa -->
                            <div id="select-metodos" class="form-control"></div>
                      ...
                      <div class="row">
                        <!-- Grupo: Btn Seleccionar Cliente -->
                        <div class="form-group col-md-6 formulario__grupo" id="grupo__cliente">
                          <label for="cliente" class="formulario__label">Seleccionar cliente requerido
                            (Opcional)</label>
                          <div class="formulario__grupo-input input-group">

                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                              data-bs-target="#seleccionarCliente">
                      ...
                      <h6 class="text-center col-12 p-4 text-muted advCliente">
                        <strong>Seleccionar un cliente</strong>
                      </h6>

                      <!-- Tabla donde deben de estar el cliente seleccionado -->
                      <div class="row table__seleccionados" id="table">
                        <div class="col-12">
                          <div class="section-title">Información del cliente</div>
                          <p class="section-lead">Toda la información precisa del cliente seleccionado.</p>
                      ...
                      <h6 class="text-center col-12 p-4 text-muted advPedido">
                        <strong>Seleccionar un pedido</strong>
                      </h6>
  ...
  <script src="../tasks/CargarClientes.js"></script>
  <script src="../tasks/CargarMetodos.js"></script>
  <script src="../tasks/CargarPedidos.js"></script>
  <script src="../controllers/CargarCliente.js"></script>
  <script src="../controllers/CargarPedido.js"></script>
  <!-- Modal para seleccionar al cliente -->
  <?php include("seleccionar-cliente.php") ?>
